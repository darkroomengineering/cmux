...
extension TerminalController {
    ...
    nonisolated func v2NotificationCreate(params: [String: Any]) -> V2CallResult {
        ...
        return v2MainSync {
            ...
            return .ok(["workspace_id": ws.id.uuidString, "surface_id": v2OrNull(surfaceId?.uuidString)])
        }
    }
    ...
    nonisolated func v2NotificationList() -> [String: Any] {
        let items: [[String: Any]] = v2MainSync {
            TerminalNotificationStore.shared.notifications.map { n in
                return [
                    "id": n.id.uuidString,
