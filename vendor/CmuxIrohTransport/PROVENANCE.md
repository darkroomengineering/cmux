...
| Source path | `Packages/Shared/CmuxIrohTransport` |
...
```sh
git archive 34cc2ba5110adf45c27607e865be5867fbcad8a9 Packages/Shared/CmuxIrohTransport \
  | tar -x --strip-components=3 -C vendor/CmuxIrohTransport
```
